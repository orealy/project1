...
(define leadGateWidth 0.070)
(define leadGateHeight 0.040)
(define leadGateOverlap 0.030)
(define leadGateOxideThickness 0.004)
...
(define barrierOxideID (isegeo:create-cuboid (position barrier1X1 barrier1Y1 0) (position barrier1X2 barrier1Y2 barrierHeight) "Insulator1" "barrierOxide"))

(define barrierOxideChamferTop (list (car (find-edge-id (position barrier1X1 centrePositionY barrierHeight))) (car (find-edge-id (position barrier1X2 centrePositionY barrierHeight))) (car (find-edge-id (position centrePositionX barrier1Y2 barrierHeight)))))
(define barrierOxideChamferBottom (list (car (find-edge-id (position barrier1X1 centrePositionY 0))) (car (find-edge-id (position barrier1X2 centrePositionY 0))) (car (find-edge-id (position centrePositionX barrier1Y2 0)))))
...
(define barrierAluminumChamferTop (list (car (find-edge-id (position (+ barrier1X1 barrierOxideThickness)  centrePositionY (- barrierHeight barrierOxideThickness)))) (car (find-edge-id (position (- barrier1X2 barrierOxideThickness)  centrePositionY (- barrierHeight barrierOxideThickness)))) (car (find-edge-id (position centrePositionX (- barrier1Y2 barrierOxideThickness)  (- barrierHeight barrierOxideThickness))))))
(define barrierAluminumChamferBottom (list (car (find-edge-id (position (+ barrier1X1 barrierOxideThickness) centrePositionY barrierOxideThicknessBottom))) (car (find-edge-id (position (- barrier1X2 barrierOxideThickness) centrePositionY barrierOxideThicknessBottom))) (car (find-edge-id (position centrePositionX (- barrier1Y2 barrierOxideThickness)  barrierOxideThicknessBottom)))))

(define barrierAluminumTaperFace (list (car (find-face-id (position (+ barrier1X1 barrierOxideThickness) centrePositionY (+ barrierOxideThicknessBottom 0.0001)))) (car (find-face-id (position (- barrier1X2 barrierOxideThickness) centrePositionY (+ barrierOxideThicknessBottom 0.0001)))) (car (find-face-id (position centrePositionX (- barrier1Y2 barrierOxideThickness) (+ barrierOxideThicknessBottom 0.0001))))))
(isegeo:taper-faces barrierAluminumTaperFace (position centrePositionX centrePositionY barrierPosition) (gvector 0 0 1) barrierAngle)

(isegeo:chamfer-edges barrierAluminumChamferTop chamferTop chamferTop)
(isegeo:chamfer-edges barrierAluminumChamferBottom chamferBottom chamferBottom)
...
(isegeo:bool-unite (list topGateAluminumBendID topGateAluminumBend2ID))
(isegeo:set-default-boolean "BAB")
(isegeo:rotate-selected topGateAluminumBendID topGateBend #f 1)
...
(define siliconOxideThickness 0.0075)
(define oxideLayerWidth domainWidth)
(define oxideLayerLength domainLength)

(define oxideLayerX1 (/ oxideLayerWidth -2))
(define oxideLayerY1 (/ oxideLayerLength -2))
(define oxideLayerX2 (/ oxideLayerWidth 2))
(define oxideLayerY2 (/ oxideLayerLength 2))

(define SDregionOverlapX 0.1)
(define SDregionOverlapY 0.1)
(define SDregionOverlapZ 0.03)


(define contactEdge 0.02)
(define contactLength 0.03)

(define sourceContact1X1 (+ leadGate1X1 contactEdge))
(define sourceContact1Y1 (+ leadGate1Y1 contactEdge))
(define sourceContact1X2 (+ sourceContact1X1 contactLength))
(define sourceContact1Y2 (- leadGate1Y2 contactEdge))

(define drainContact1X1 (- sourceContact1X1))
(define drainContact1Y1 sourceContact1Y1)
...
(isegeo:define-3d-contact (entity:faces barrierAluminumID) "barrierLeft1")
(isegeo:define-3d-contact (entity:faces (car(find-body-id (position (/ (+ barrierWidth dotLength) 2) centrePositionY (/ barrierHeight 2))))) "barrierRight1")
(isegeo:define-3d-contact (entity:faces topGateAluminumID) "topGate1")
(isegeo:define-3d-contact (entity:faces leadGateAluminumID) "leadGateLeft1")
(isegeo:define-3d-contact (entity:faces (car(find-body-id (position 0.5 centrePositionY (/ barrierHeight 2))))) "leadGateRight1")
...
(isegeo:define-3d-contact (entity:faces (car(find-body-id (position (/ (+ barrierWidth dotLength) -2) (- centrePositionY) (/ barrierHeight 2))))) "barrierLeft2")
(isegeo:define-3d-contact (entity:faces (car(find-body-id (position (/ (+ barrierWidth dotLength) 2) (- centrePositionY) (/ barrierHeight 2))))) "barrierRight2")
(isegeo:define-3d-contact (entity:faces (car(find-body-id (position 0 (- centrePositionY) (/ barrierHeight 2))))) "topGate2")
...
(isegeo:imprint-rectangular-wire (position drainContact1X1 drainContact1Y1 (- siliconOxideThickness)) (position drainContact1X2 drainContact1Y2 (- siliconOxideThickness)))
(define drainID (find-face-id (position (- drainContact1X1 0.0001) (+ drainContact1Y1 0.0001) (- siliconOxideThickness))))
...
(isegeo:imprint-rectangular-wire (position drainContact2X1 drainContact2Y1 (- siliconOxideThickness)) (position drainContact2X2 drainContact2Y2 (- siliconOxideThickness)))
(define drainID (find-face-id (position (- drainContact2X1 0.0001) (- drainContact2Y1 0.0001) (- siliconOxideThickness))))
(isegeo:define-3d-contact drainID "drain2")


(isedr:define-refinement-window "sourceRegion2" "Cuboid" (position sourceContact2X1 sourceContact2Y1 (- siliconOxideThickness)) (position sourceContact2X2 sourceContact2Y2 (- -0.01 siliconOxideThickness)))
(isedr:define-refinement-window "drainRegion2" "Cuboid" (position drainContact2X1 drainContact2Y1 (- siliconOxideThickness)) (position drainContact2X2 drainContact2Y2 (- -0.01 siliconOxideThickness)))
